...
if __name__ == '__main__':
    ...
    for i in range(0, 100):
        src = torch.randn(32,100,512, dtype=torch.float32).to(device)
        src_mask = torch.randint(0,2,(32,100), dtype=torch.float32).to(device)
        trg = torch.randn(32,150,512, dtype=torch.float32).to(device)
        trg_mask = torch.ones((32,150,150), dtype=torch.float32).to(device)
